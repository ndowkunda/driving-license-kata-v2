...
class TestDrivingLicenseGenerator:
  ...
  def test_returns_surname_in_first_5_chars(test_input,expected):
    driving_license = DrivingLicense()
    driving_license_number = driving_license.generate_license_number(test_input)
  ...
  def test_returns_decade_number_from_birth_year_at_sixth_char(data_input,expected):
    driving_license = DrivingLicense()
    driving_license_number = driving_license.generate_license_number(data_input)
